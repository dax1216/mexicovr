; (function($) {
    ...
    $.fn.datepicker = function(o) {
        ...
        if (cp.length == 0) {
            var cpHA = [];
            cpHA.push("<div id='BBIT_DP_CONTAINER' class='bbit-dp' style='width:215px;z-index:999;'>");
            if ($.browser.msie6) {
            ...
            cpHA.push("<table class='dp-maintable' cellspacing='0' cellpadding='0' style='width:215px;'><tbody><tr><td>");
