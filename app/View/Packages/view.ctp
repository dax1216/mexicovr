...
<h2><?php  echo __('Package'); ?></h2>
	<dl>
		...
		<dt><?php echo __('Is Audio Enabled'); ?></dt>
		<dd>
			<?php echo h($package['Package']['is_audio_enabled']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Is Video Enabled'); ?></dt>
		<dd>
			<?php echo h($package['Package']['is_video_enabled']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Is Active'); ?></dt>
		<dd>
			<?php echo h($package['Package']['is_active']); ?>
			&nbsp;
		</dd>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($package['Property'] as $property): ?>
		<tr>
