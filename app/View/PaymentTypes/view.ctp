...
<h2><?php  echo __('Payment Type'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($paymentType['PaymentType']['icon']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Is Active'); ?></dt>
		<dd>
			<?php echo h($paymentType['PaymentType']['is_active']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($paymentType['PaymentType']['updated']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<?php if (!empty($paymentType['Property'])): ?>
	...
	<?php
		$i = 0;
		foreach ($paymentType['Property'] as $property): ?>
		<tr>
