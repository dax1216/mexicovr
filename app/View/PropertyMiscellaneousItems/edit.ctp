...
<?php echo $this->Form->create('PropertyMiscellaneousItem'); ?>
	<fieldset>
		<legend><?php echo __('Edit Property Miscellaneous Item'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PropertyMiscellaneousItem.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PropertyMiscellaneousItem.id'))); ?></li>
